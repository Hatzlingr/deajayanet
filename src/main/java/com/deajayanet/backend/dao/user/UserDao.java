package com.deajayanet.backend.dao.user; // Package diubah menyesuaikan
...
import com.deajayanet.backend.model.user.Member;
import com.deajayanet.backend.model.user.User;
import com.deajayanet.backend.model.user.Admin;
import com.deajayanet.backend.model.user.Vip;
